...
public class ProdutoService{
    ...
    private void adicionarProdutoInicial() {
        String nome = "Not@@ebook";
        String marca = "Dell";
        String categoria = "Eletrônicos";
        BigDecimal price = new BigDecimal(1000); // Use BigDecimal para o preço
        int quantidade = 10;

        // Criar o produto e persistir no banco
        customDAOProduto.CriarProduto(new ProdutoEntity(0, nome, categoria, price, quantidade, marca));
    }
}
